{
  ...
  "2.11" = {
    ...
    supportedTorchRocmArchs = [
      # https://github.com/pytorch/pytorch/blob/release/2.11/.ci/docker/almalinux/build.sh
      "gfx900"
      "gfx906"
      "gfx908"
      "gfx90a"
  ...
  "2.12" = {
    # https://github.com/pytorch/pytorch/blob/release/2.12/.ci/manywheel/build_cuda.sh
    capsPerCudaVersion = {
      "13.2" = [
        "7.5"
        "8.0"
    ...
    supportedTorchRocmArchs = [
      # https://github.com/pytorch/pytorch/blob/release/2.12/.ci/docker/almalinux/build.sh
      "gfx900"
      "gfx906"
      "gfx908"
      "gfx90a"
