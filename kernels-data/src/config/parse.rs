...
pub fn parse_and_validate(kernel_dir: impl AsRef<Path>) -> Result<CurrentConfig> {
...
pub fn parse_and_validate_compat(kernel_dir: impl AsRef<Path>) -> Result<BuildCompat> {
