...
def _import_from_path(
    ...
    kernel_deps: dict[str, ModuleType] | None = None,
) -> ModuleType:
    ...
    # TODO: Remove once all callers pass this dict. Also update the type signature
    # above.
    if kernel_deps is None:
        kernel_deps = {}

    # TODO: Here because of load cycle, to be fixed.
