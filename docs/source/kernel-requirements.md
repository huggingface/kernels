...
- `minver` (`str`, optional): the minimum version of the `kernels`
  Python library required to load the kernel (e.g. `"0.11.0"`). The
  `kernels` library warns when it loads a kernel that requires a newer
